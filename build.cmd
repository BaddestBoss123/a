...
call ktx2.cmd
del ktx2.cmd
clang src/dwrite.cpp src/client.c -DCLIENT -Ofast -o build/client_speed.exe %COMPILE_FLAGS% %LINK_FLAGS%
clang src/dwrite.cpp src/client.c -DCLIENT -Oz -o build/client_size.exe %COMPILE_FLAGS% %LINK_FLAGS%
