...
glslangValidator src/shaders/blit.vert -V --vn blit_vert -o src/shaders/blit.vert.h
glslangValidator src/shaders/blit.frag -V --vn blit_frag -o src/shaders/blit.frag.h
...
glslangValidator src/shaders/particle.vert -V --vn particle_vert -o src/shaders/particle.vert.h
glslangValidator src/shaders/particle.frag -V --vn particle_frag -o src/shaders/particle.frag.h
glslangValidator src/shaders/portal.vert -V --vn portal_vert -o src/shaders/portal.vert.h
glslangValidator src/shaders/portal.frag -V --vn portal_frag -o src/shaders/portal.frag.h
glslangValidator src/shaders/voxel.vert -V --vn voxel_vert -o src/shaders/voxel.vert.h

set COMPILE_FLAGS=-fno-unwind-tables -fno-rtti -fno-asynchronous-unwind-tables -fno-exceptions -nostdlib -mcmodel=small -mavx2 -mfma -fenable-matrix -mno-stack-arg-probe -Iinclude
...
clang src/assets/asset_generator.c -Ofast -o src/assets/asset_generator.exe %COMPILE_FLAGS% %LINK_FLAGS% -Xlinker -subsystem:console
pushd src
pushd assets
asset_generator.exe
popd
